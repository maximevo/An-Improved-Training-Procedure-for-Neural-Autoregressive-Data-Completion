...
('/home/maximev/results_experiments/small/adult/model_1/scenario_2/150350958434/model_saved','model_1', 'adult', 'scenario_2'),
    ...
    ('/home/maximev/results_experiments/large/adult/model_3/scenario_1/150380495014/model_saved','model_3', 'adult', 'scenario_1'),
    ('/home/maximev/results_experiments/large/adult/model_1/scenario_2/150385417837/model_saved','model_1', 'adult', 'scenario_2'),
    ...
    ('/home/maximev/results_experiments/small/dna/model_3/scenario_2/150368585285/model_saved','model_3', 'dna', 'scenario_2'),
    ('/home/maximev/results_experiments/large/dna/model_1/scenario_1/150385310013/model_saved','model_1', 'dna', 'scenario_1'),
    ('/home/maximev/results_experiments/large/dna/model_3/scenario_1/150385238923/model_saved','model_3', 'dna', 'scenario_1'),
    ('/home/maximev/results_experiments/large/dna/model_1/scenario_2/150385336847/model_saved','model_1', 'dna', 'scenario_2'),
    ('/home/maximev/results_experiments/large/dna/model_3/scenario_2/15038526442/model_saved','model_3', 'dna', 'scenario_2'),
    ('/home/maximev/results_experiments/large/dna/model_1/scenario_3/150385361384/model_saved','model_1', 'dna', 'scenario_3'),
    ('/home/maximev/results_experiments/large/dna/model_3/scenario_3/150385293143/model_saved','model_3', 'dna', 'scenario_3'),
    ('/home/maximev/results_experiments/small/mushrooms/model_1/scenario_1/150381030531/model_saved','model_1', 'mushrooms', 'scenario_1'),
    ('/home/maximev/results_experiments/small/mushrooms/model_3/scenario_1/150381508045/model_saved','model_3', 'mushrooms', 'scenario_1'),
    ('/home/maximev/results_experiments/small/mushrooms/model_1/scenario_2/150377752982/model_saved','model_1', 'mushrooms', 'scenario_2'),
...
for (path_to_restore,model,dataset,scenario) in xp_to_launch:
    ...
    mean_log_prob = np.nanmean(losses_test) # this depends on the sizes of the constraints chosen...
    # this is the mean of each 1D cond: multiply by timeslice size to get a number comparable to train
    mean_log_prob *= timeslice_size
    print("for info: mean_log_prob val",mean_log_prob)

    total_loss_test_normalized_avg_constraints = float(total_loss_test_normalized_avg_constraints)/n_random_constraints_test
