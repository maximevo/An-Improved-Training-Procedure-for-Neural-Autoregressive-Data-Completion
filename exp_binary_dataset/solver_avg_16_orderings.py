...
class Solver:
        ...
        def __init__(self, config, model_train, train_data, val_data, test_data, my_scenario, my_model, my_size):
                ...
                #CREATE A LIST OF 16 ORDERING, SORTING_DICT AND MP
                mp_16 = []
                sorting_dict_16 = []
                ...
                for index in range(16):
                    ...
                    ordering_list = list(np.random.choice(a = universe,size = self.config.timeslice_size , replace = False))
        ...
        def validation(self,sv,session,variables_val,n_batch_per_epoch,\
                ...
                total_loss_val_normalized_avg_constraints = float(total_loss_val_normalized_avg_constraints)/(16.*n_random_constraints_val)
                ...
                print("what we care about: total_loss_val_normalized_avg_constraints val over 16 constraints ",total_loss_val_normalized_avg_constraints)
